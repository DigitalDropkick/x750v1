...
local overrides = { ["network.snmp"]={community="synthetic-test-community"}, ["storage.clone"]={target="/dev/sdc"}, ["cellular.profile"]={apn="test.example"}, ["auth.otp"]={key="3132333435363738393031323334353637383930",base32=false,mode="hotp",counter=0},
